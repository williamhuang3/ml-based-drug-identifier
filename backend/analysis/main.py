...
def generate_plots(df):
    ...
    try:
        ...
        # Add regression plot if it exists (generated by ML analysis)
        regression_plot_path = os.path.join(get_data_directory('outputs'), 'predicted_experimental_pIC50.png')
        if os.path.exists(regression_plot_path):
            plot_info.append({
            ...
            logger.info("Added regression plot to results")
