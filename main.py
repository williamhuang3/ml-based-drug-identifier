...
def run_ml_analysis(df):
    ...
    try:
        ...
        result = subprocess.run(['bash', 'padel.sh'], capture_output=True, text=True, timeout=300)
...
def generate_regression_plot(y_test, predictions):
    ...
    try:
        ...
        # Save plot
        plt.savefig('assets/predicted_experimental_pIC50.png', dpi=300, bbox_inches='tight')
        plt.close()
